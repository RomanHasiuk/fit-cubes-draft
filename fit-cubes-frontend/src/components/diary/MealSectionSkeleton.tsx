...
export const MealSectionSkeleton: React.FC<MealSectionSkeletonProps> = ({ itemCount = 2 }) => {
  return (
    <div className="rounded-[5px] border border-[#32363E] bg-[#16181D]/60 backdrop-blur-sm overflow-hidden mb-3">
      {/* Header Skeleton */}
      <div className="flex items-center justify-between px-2.5 py-2.5 bg-white/5 border-b border-white/5">
      ...
      <div className="px-2.5 py-2 bg-black/5 dark:bg-white/5 flex justify-end">
